...
//
//  @Brief  ex12.2 编写你自己的 StrBlob 类, 包含 const 版本的 front 和 back.

#ifndef CPP_PRIMER_CMT_12_STR_BLOB
#define CPP_PRIMER_CMT_12_STR_BLOB
...
public:
    ...
    void pushBack(std::string const &) const;
